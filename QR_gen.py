...
label1 = Label(Frame1, text="Enter the text/URL: ", bg=background_color, fg='azure', font=('FiraMono', 13, 'bold'))
...
label2 = Label(Frame2, text="Enter the location to save the QR Code: ", bg=background_color, fg='azure', font=('FiraMono', 13, 'bold'))
...
label3 = Label(Frame3, text="Enter the name of the QR Code: ", bg=background_color, fg='azure', font=('FiraMono', 13, 'bold'))
...
label4 = Label(Frame4, text="Enter the size from 1 to 40 with 1 being 21x21: ", bg=background_color, fg='azure', font=('FiraMono', 13, 'bold'))
...
fillColorLabel = Label(Frame5, text=f"Selected QR color: {qr_fill_color}", bg=background_color, fg='azure', font=('FiraMono', 10))
fillColorLabel.place(relx=0.05, rely=0.5)

backColorLabel = Label(Frame5, text=f"Selected background color: {qr_back_color}", bg=background_color, fg='azure', font=('FiraMono', 10))
